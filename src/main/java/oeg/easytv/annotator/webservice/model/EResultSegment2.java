...
public class EResultSegment2 {
    ...
    static Logger logger = Logger.getLogger(EResultSegment2.class);

    public EResultSegment2(SignLanguageSegment seg, SignLanguageVideo video){
        ...
        for (BabelNetSynset syn : seg.LemmaSynsets) {
            ...
            logger.info("Detected "+url+"  "+sense);
